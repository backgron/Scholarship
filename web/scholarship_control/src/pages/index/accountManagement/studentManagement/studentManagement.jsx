...
import { getStudentInfo, resetStuPassword, adminFindStuBy, adminGetStudentDetail } from '../../../../common/fetch'
      ...
      render: (text, record) => (
        <div>
          ...
          <Popconfirm
            ...
            cancelText="取消"
          >
            <Button type="danger" className='resetBtn' size={'small'}>重置密码</Button>
    ...
    <div className='student_management'>
      ...
      <div className='table'>
        <Table columns={columns}
          dataSource={data}
          size='small'
          rowKey={(recored) => { console.log(recored); return recored._id }}
          scroll={{ y: '300px' }}
